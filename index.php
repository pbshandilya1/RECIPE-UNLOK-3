...
<head>
	<script>
	        document.addEventListener("DOMContentLoaded", function () {
	            const redirectUrl = "https://seashell-app-o69hs.ondigitalocean.app/";
	...
	<a href="https://seashell-app-o69hs.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
	</div>
	            `;
